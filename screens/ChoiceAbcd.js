...
export default class ChoiceAbcd extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      <View style={styles.container}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            this._countScore(this.state.answerA);
          }}
        >
        ...
        <TouchableOpacity
          style={styles.answerButton}
          onPress={() => {
            this._countScore(this.state.answerB);
          }}
        >
        ...
        <TouchableOpacity
          style={styles.answerButton}
          onPress={() => {
            this._countScore(this.state.answerC);
          }}
        >
        ...
        <TouchableOpacity
          style={styles.answerButton}
          onPress={() => {
            this._countScore(this.state.answerD);
          }}
        >
